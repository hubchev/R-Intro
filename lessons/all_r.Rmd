...
* Describe what R and R* Interact with R using RStudio.
...
#	LaTeX and Project Work (Course Description)
...
Please prepare a suggestion for a topic, i.e., a potential
title for the lecture. We'll discuss all
suggestions next week and than we assign topics so that
everybody is happy with his project. Maybe the following
webpage inspires you to find an appealing project-title:
[https://data-flair.training/blogs/data-science-tutorials-home/](https://data-flair.training/blogs/data-science-tutorials-home/)
The webpage contains inspiring tutorials that may work as a
blueprint and/or starting point for your lecture.
Nevertheless, I'll also suggest some potential projects.

<a name="listtopics"></a>

### List of Potential Working Titles for a Project

#### TOPIC 1: __Can you do Data Science with 37 Euros?__

_Background:_ Single Board Computers (SBC) like the Raspberry Pi have become enormous powerfull while remaining rather cheap. These Mini-PCs can be used for data scientific purpose in multiple ways. The lecture should give a rough overview thereto.
You find plenty of examples what a SBC can do with respect to collecting data, analyzing data, or to employ machine learning tools and artificial intelligence. Here are just some examples:
 - [Face recognition](tps://github.com/Azure/AzureVision)
 - [Social Media Data Mining With Raspberry Pi (Part 4: Installing R)](https://youtu.be/jZuiy8oBRew)
 - etc. 
 
Other links:
  
  - Here is a full fletched book about this topic: [Beginning Data Science, IoT, and AI on Single Board Computers
Core Skills and Real-World Application with the BBC](https://www.springer.com/de/book/9781484257654)
  - Here is a journal article about the topic [Commodity single board computer clusters and their applications](https://doi.org/10.1016/j.future.2018.06.048)
  
#### TOPIC 2: __What you see on Facebook is what Mrs. Algorithm shows you__ (Linh Vu and Tai Chi Wu)

_Background:_ Facebook aims to increase the user experience and maximize its profits by engage people. Therefore, Facebook shows posts and advertisement to its costumers. The _logic_ of the automated decision making process is ruled by a complex algorithm that takes advantage of several insights from data science. The lecture should give a brief overview on that.

Links:

  - [Facebooks Algorithm History](https://blog.hootsuite.com/facebook-algorithm/)
  - [Brand Marketing on Facebook using Statistical Analysis and R](https://towardsdatascience.com/brand-marketing-on-facebook-using-statistical-analysis-7ec4210999b0)

#### TOPIC 3: __It Is So Easy To Explain Elections (If You Know R)__

_Background:_ To understand the voter will, elections need to be analyzed. R can help here. There are libraries available containing election results (cf. [USA](https://cran.r-project.org/web/packages/elections/elections.pdf), [Germany](https://cran.r-project.org/web/packages/GermaParl/index.html), [Brazil](https://cran.r-project.org/web/packages/electionsBR/electionsBR.pdf)) and some time ago the [_R Election Analysis Contest_](https://arilamstein.com/blog/2016/04/18/r-election-analysis-contest-results/) has shown that R is a powerful tool to analyze elections.  

Links:

  - [Online Course: Analyzing Election and Polling Data in R](https://learn.datacamp.com/courses/analyzing-election-and-polling-data-in-r)


#### TOPIC 4: __We Need It Now: How To Analyze COVID Data Quick__ (Alisa Ishikawa and Pirneeta Bhambhani and Ahmed Hifaz)

_Background:_ To fight COVID we should use the available data quick and efficient. R can help here. Not only that R allows to visualize data nicely with, for example, heatmaps. The _R Language and Environment for Statistical Computing_ offers an excellent tool and ecosystem for approaches focusing on open science and reproducible results. Hence it is not surprising that with the onset of the pandemic, a large number of R packages and resources were made available for researches working in the pandemic. In a recent paper of Ponce and Sandhel,  an R package is presented that allows users to access and analyze worldwide data from resources publicly available.

Links: 

  - The mentioned paper: [covid19.analytics: An R Package to Obtain, Analyze and Visualize Data from the Corona Virus Disease Pandemic](https://arxiv.org/pdf/2009.01091.pdf) 
  - [CoronaDash app use case – Clustering countries’ COVID-19 active cases trajectories](https://www.r-bloggers.com/2020/05/coronadash-app-use-case-clustering-countries-covid-19-active-cases-trajectories/)

#### TOPIC 5: __I Am So Lost, Can Somebody Explain What I Need To Know as a Data Scientist When Working With R?__

_Background:_ R has a lot to offer when it comes to collect, manipulate, visualize, and analyze data. It allows to implement methods steming from research of machine learning, artificial inteligence and big data. In numbers, the CRAN package repository features currently 16599 available packages. As nobody can have a look at all the packages, we need orientation. Thus, the lecture should give a brief introduction to the possibilities of a selection of more useful packages in R. 

Links:

  - [Best R Libraries and Packages for Data Science](https://towardsdatascience.com/top-r-libraries-for-data-science-54f6eba4a78f)

#### TOPIC 6: **Storytelling with R**

![](http://rismyhammer.com/images/chartSelections.jpg)

_Background:_ Albeit all the fancy and sophisticated methods, _simple_ explorative data analysis remains important and powerful to draw insights and tell stories,  respectively. Graphical viszualizations become more and more popular as the possibilities to create nice, meaningful and interactive graphs steadily increase. R is one of the main driver here. The lecture should introduce the power of R to visualize data.  

Links:

  - [Let Graphics Tell the Story - Datasets in R](https://journal.r-project.org/archive/2013/RJ-2013-012/RJ-2013-012.pdf)
  - [Chapter 11 Tell Your Story with Data](https://moderndive.com/11-thinking-with-data.html)
  - [R Graph Gallery](https://www.r-graph-gallery.com/all-graphs.html)

#### TOPIC 7: __Who's Your Costumer? Data Scientists Can Tell__ (       )

_Background:_ Customer segmentation allows to detect customer profiles. This analysis can be done by R. This lecture should discuss the importance of customer segmentation for business and should briefly show how R can help here.  

Links:

  - [Cuostomer Analytics with R](https://josepcurtodiaz.gitbooks.io/customer-analytics-with-r/content/chapter7.html)
  
#### TOPIC 8: __Artificial intelligence vs. COVID-19__ (Ranjodh Singh and Dhruvin Bhanushali)

_Background:_  Methods of AI can help to fight COVID. The lecture should give an overview on the possibilities to fight the disease. 


Links: 
  
  - [Intelligente Eindämmungsstrategien gegen COVID-19:  Die Rolle von KI und großen Daten](https://doi.org/10.1515/pwp-2020-0021 )
  - [Artificial intelligence vs COVID-19: limitations, constraints and pitfalls](https://link.springer.com/article/10.1007/s00146-020-00978-0)
...
- This presentation is available on ILIAS
...
- [Earth at Night](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwiwm-OwuL7tAhXLqqQKHZnAB7sQFjAAegQIAhAC&url=https%3A%2F%2Fearth.google.com%2Fweb%2Fdata%3DCiQSIhIgMGY3ZTJkYzdlOGExMTFlNjk5MGQ2ZjgxOGQ2OWE2ZTc&usg=AOvVaw2H1m38-Kqv490o3zSZQRFV)
- [Lecture: Spatial Data Science of Prof. Luc Anselin](https://www.youtube.com/playlist?list=PLzREt6r1Nenlu-MBaxCRL2KZNk62n7o1g) 
- [Links: Tutorials on Spatial Analysis in the R Programming Language](https://spatialanalysis.github.io/tutorials/)
- [Tutorial: An Introduction to Spatial Data Analysis and Visualisation in R ](https://www.spatialanalysisonline.com/An%20Introduction%20to%20Spatial%20Data%20Analysis%20in%20R.pdf)
- [Data: An Introduction to Spatial Data Analysis and Visualisation in R ](https://data.cdrc.ac.uk/dataset/introduction-spatial-data-analysis-and-visualisation-r)
- [Data: US COVID Atlas](https://geodacenter.github.io/covid/index.html)
- [Book: Geocomputation with R](https://geocompr.robinlovelace.net/)
- [Book: An Introduction to Spatial Data Analysis and Visualisation in R](https://www.spatialanalysisonline.com/An%20Introduction%20to%20Spatial%20Data%20Analysis%20in%20R.pdf)
- [Book: R Spatial Workshop Notes](https://spatialanalysis.github.io/workshop-notes/index.html)
