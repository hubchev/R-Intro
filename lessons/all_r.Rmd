...
# Name and explain briefly ways to get help via the Console.
...
# Name the arithmetic operators (plus, minus, etc.) in R.  
...
It's the logical operator for negation and it also means the opposite of a command.
