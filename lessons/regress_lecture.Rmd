...
- This presentation is available online: [html slides](https://github.com/hubchev/R-Intro/blob/master/lessons/regress_lecture.html) and [R Markdown file](https://raw.githubusercontent.com/hubchev/R-Intro/master/lessons/regress_lecture.Rmd)
...
![](~/Dropbox/hsf/pic/destat/corelate_overview.png){ width=65% }
